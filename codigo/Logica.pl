...
comecaJogo(Tabuleiro) :-
	Jogador is 1,
	jogo(Tabuleiro, Jogador, 0, 0, 0, 0 ,0).
...
colocaTorre(Tabuleiro, _, _, Torres, N) :-
...
verificaTorre(Tabuleiro, Jogador, _, _, _, _, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	moveTorreAviso,
	executaJogada(Tabuleiro, Jogador, 2, 0, P1Passou, P2Passou, P1Afundou, P2Afundou).
...
moveTorre(Tabuleiro, Jogador, X, Y, XFinal, YFinal, XLimite, YLimite, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	...
	jogo(Tabuleiro3, Jogador2, 0, P1Passou, P2Passou, P1Afundou, P2Afundou).
	
	
moveTorre(Tabuleiro, Jogador,_, _, _, _, _, _, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	moveTorreFinalAviso,
...
afundaCasa(Tabuleiro, Jogador, X, Y, XLimite, YLimite, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	posicoesTorre(Tabuleiro, Jogador, Px, Py, XLimite, YLimite, 1),
	posicoesTorre(Tabuleiro, Jogador, Px2, Py2, XLimite, YLimite, 2),
	verificaAdjacencia(Tabuleiro, Jogador,Px, Py, Px2, Py2, X, Y, XLimite, YLimite, P1Passou, P2Passou, P1Afundou, P2Afundou).
	
afundaCasa(Tabuleiro, Jogador, _, _, _, _, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	afundaCasaFinalAviso,
	jogo(Tabuleiro, Jogador, 0, P1Passou, P2Passou, P1Afundou, P2Afundou).
	
	

verificaAdjacencia(Tabuleiro, 1,Px, Py, Px2, Py2, X, Y, XLimite, YLimite, P1Passou, P2Passou, P1Afundou, _) :-
	PxMais is Px + 1,
	PxMenos is Px - 1,
	PyMais is Py + 1,
	PyMenos is Py - 1,
	...
	Afundou1 is P1Afundou + 1,
	jogo(Tabuleiro2, 2, 0, P1Passou, P2Passou, Afundou1, 0).
	
	
verificaAdjacencia(Tabuleiro, 2, Px, Py, Px2, Py2, X, Y, XLimite, YLimite, P1Passou, P2Passou, _, P2Afundou) :-
	PxMais is Px + 1,
	PxMenos is Px - 1,
	PyMais is Py + 1,
	PyMenos is Py - 1,
	...
	verificaTabuleiroLigado(Tabuleiro, XLimite, YLimite),
	removeCasa(Tabuleiro, Tabuleiro2, X, Y, XLimite, YLimite),
	Afundou1 is P2Afundou + 1,
	jogo(Tabuleiro2, 1, 0, P1Passou, P2Passou, 0, Afundou1).
	
	
verificaAdjacencia(Tabuleiro, Jogador,_, _, _, _, _, _, _, _, P1Passou, P2Passou, P1Afundou, P2Afundou) :-
	afundaCasaFinalAviso,
	jogo(Tabuleiro, Jogador, 0, P1Passou, P2Passou, P1Afundou, P2Afundou).
...
verificaCasaVazia(Tabuleiro, Lista, X, Y, XFinal, YFinal, XLimite, YLimite) :-
	X >= 0, X < XLimite, Y >= 0, Y < YLimite, 
	obtemCasa(Tabuleiro, Casa, X, Y, XLimite, YLimite),
	Casa == vazio,
	verificaLista(Lista, [X, Y]),
	append(Lista, [[X, Y]], Lista2),
	verificaIgualdadeVazia(Tabuleiro, Lista2, X, Y, XFinal, YFinal, XLimite, YLimite).
	
	
verificaIgualdadeVazia(_, _, X, Y, XFinal, YFinal, _, _) :-
	X == XFinal,
	Y == YFinal.
	
verificaIgualdadeVazia(Tabuleiro, Lista, X, Y, XFinal, YFinal, XLimite, YLimite) :-
	XMais is X + 1,
	XMenos is X - 1,
	YMais is Y + 1,
	YMenos is Y - 1,
	(verificaLista(Lista, [XMais, Y]); verificaLista(Lista, [XMenos, Y]); verificaLista(Lista, [X, YMais]); verificaLista(Lista, [X, YMenos])),
	(verificaCasaVazia(Tabuleiro, Lista, XMais, Y, XFinal, YFinal, XLimite, YLimite);
	verificaCasaVazia(Tabuleiro, Lista, XMenos, Y, XFinal, YFinal, XLimite, YLimite);
	verificaCasaVazia(Tabuleiro, Lista, X, YMais, XFinal, YFinal, XLimite, YLimite);
	verificaCasaVazia(Tabuleiro, Lista, X, YMenos, XFinal, YFinal, XLimite, YLimite)).
